...
public partial class BanticanFintechContext : DbContext
{
    public BanticanFintechContext()
    {
    }

    public BanticanFintechContext(DbContextOptions<BanticanFintechContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=wdb4.my-hosting-panel.com;Database=bantican_fintech;User ID=bantican_fintech;Password=Bantic2023;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("bantican_fintech");
        ...
        modelBuilder.Entity<CustomerBank>(entity =>
        {
            ...
            entity.HasOne(d => d.FkBankNavigation).WithMany(p => p.CustomerBanks)
                ...
                .HasConstraintName("FK__customerB__fkBan__3E52440B");

            entity.HasOne(d => d.FkCustomerNavigation).WithMany(p => p.CustomerBanks)
                .HasForeignKey(d => d.FkCustomer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__customerB__fkCus__3D5E1FD2");
        });
        ...
        modelBuilder.Entity<HistoryLog>(entity =>
        {
            ...
            entity.Property(e => e.Bank)
                ...
                .IsFixedLength()
                .HasColumnName("bank");
            entity.Property(e => e.CodeInter)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("codeInter");
            ...
            entity.Property(e => e.Level)
                ...
                .IsUnicode(false)
                .HasColumnName("level");
            entity.Property(e => e.Messageoutput)
                .HasMaxLength(500)
                .IsUnicode(false)
                .HasColumnName("messageoutput");
        ...
        modelBuilder.Entity<ManageToken>(entity =>
        {
            ...
            entity.HasOne(d => d.FkCustomerNavigation).WithMany(p => p.ManageTokens)
                .HasForeignKey(d => d.FkCustomer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__manageTok__fkCus__38996AB5");
        });
